...
subjects = {'p7','p8','p9','p10','p11','p12','p13','p14','p15','p16','p17',...
  'p18','p19','p20','p21','p22','p23','p25','p26','p27','p28','p29','p30','p31','p32','p33'};
...
for sb = 1:length(subjects)
    ...
    if ismac
        rootdir = '';
        outdir = 'C:\Users\User\Documents\MATLAB\EEG script\11_Final_products\TFR';
        ...
        rootdir = append('C:\Users\User\Documents\MATLAB\EEG script\03_TFR+09_Data_after_cleaning\09_Data_after_cleaning\'); % Add the path of the TF data: _freq.mat
        ave_freq1{sb} = load(string(append(rootdir, subj,'_',cmp1,'_freq.mat'))).freq_tap;
        ave_freq2{sb} = load(string(append(rootdir, subj,'_',cmp2,'_freq.mat'))).freq_tap;
        outdir = 'C:\Users\User\Documents\MATLAB\EEG script\11_Final_products\';
    end
end
